...
{
    public partial class TitledView : TemplatedControl, IContentControl, IContentPresenterHost
    {
        /// <summary>
        ...
        static TitledView()
        {
            ContentProperty.Changed.AddClassHandler<TitledView>((x, e) => x.ContentChanged(e));
        }
